// =====================================================================
// Java Original: kr/dogfoot/hwplib/object/bodytext/control/ControlFootnote.java
...
namespace HwpLib.Object.BodyText.Control
{
    ...
    /// 각주(FootNote) 컨트롤
    /// </summary>
    public class ControlFootnote : Control
    {
        /// <summary>
        /// 각주/미주용 리스트 헤더
        /// </summary>
        ...
        /// 각주용 컨트롤 헤더를 반환한다.
        /// </summary>
        /// <returns>각주용 컨트롤 헤더</returns>
        public new CtrlHeaderFootnote Header => (CtrlHeaderFootnote)base.Header!;
        ...
        {
            var cloned = new ControlFootnote();
