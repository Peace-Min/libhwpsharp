...
public static class BlankFileMaker
{
    ...
    {
        byte[] compressedJsVersion = [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
        hwpFile.Scripts.JScriptVersion = compressedJsVersion;

        byte[] compressedDefaultJScript = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF];
