...
/// <summary>
/// 파일에 이미지와 이미지 컨트롤을 삽입하는 테스트
/// </summary>
[TestClass]
public class InsertingImageTest
{
    ...
    private Rectangle _shapePosition = new(50, 50, 100, 100);

    [TestMethod]
    public void InsertShapeWithImage_ShouldSucceed()
    {
        // Arrange
    ...
    private void InsertShapeWithImage(HWPFile hwpFile)
    {
        _hwpFile = hwpFile;
